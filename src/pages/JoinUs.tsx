...
const list = ['公司简介', '招聘岗位', '报名方式', '求职信', '简历'];

const sections = [
  {
    title: '公司简介',
    paragraph: [
      '作为一家制度创新实验室，量潮科技希望可以帮助人类更美好的协作，以促进解放全人类的创造力。',
      '量潮科技主营业务包括大数据处理服务、大数据技术课程与软件技术咨询，是浙江理工大学计算机系大数据微专业机构授课方。',
    ],
    imageUrl: ''
  },
  {
    title: '招聘岗位',
    paragraph: [
      '实习岗位覆盖技术类、产品类、市场类和职能类。',
      '最新的岗位要求、报名方式、求职信与简历指南，请访问招聘官网：',
...
export default function News() {
  /* 招聘信息已迁至招聘官网（qtrecurit site），此处保留指引入口 */
  return (
    <div>
      {/* 加入我们 */}
